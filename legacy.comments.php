...
<?php if ($comments) : ?>
	<h3 id="comments">&sect; <?php comments_number('No Responses', 'One Response', '% Responses'); ?> to
		&#8220;<?php the_title(); ?>&#8221;</h3>
	...
	<ul class="commentlist">
		...
		<?php foreach ($comments as $comment) : ?>
			...
			<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
				...
				<ul class="commentmeta">
					<li class="ctitle"><strong>Name:</strong> <?php comment_author_link() ?></li>
					<li class="ctitle"><strong>Date:</strong> <a href="#comment-<?php comment_ID() ?>"
																 title=""><?php comment_date('F jS, Y') ?></a> <?php edit_comment_link('edit', '&nbsp;&nbsp;', ''); ?>
					</li>

					<?php if ($comment->comment_approved == '0') : ?>
						<li class="ctitle moderation"><em>Your comment is awaiting moderation.</em></li>
					<?php endif; ?>
...
<?php if ('open' == $post->comment_status) : ?>
	...
	<h3 id="respond">&sect; Leave a Reply</h3>
