<div id="supplementary">
	<div class="meta">
		...
		<?php } elseif (is_single()) { ?>
			<div class="post_nav">
				...
				<ul class="single_post_meta">
					...
					<li><strong>Comments: </strong><?php comments_number('No Comments', '1 Comment', '% Comments'); ?>
					</li>
		...
		<?php } elseif (is_month()) { ?>
			<div class="post_nav">
				<h3>Where am I?</h3>
				<p>You are currently viewing the archives for <strong><?php the_time('F, Y'); ?></strong> at <a
							href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a>.</p>
				<div class="spacer"></div>
			</div>
		...
		<?php } elseif (is_year()) { ?>
			<div class="post_nav">
				<h3>Where am I?</h3>
				<p>You are currently viewing the archives for <strong><?php the_time('Y'); ?></strong> at <a
							href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a>.</p>
				<div class="spacer"></div>
			</div>
		...
		<?php } elseif (is_day()) { ?>
			<div class="post_nav">
				<h3>Where am I?</h3>
				<p>You are currently viewing the archives for <strong><?php the_time('l, F jS, Y'); ?></strong> at <a
							href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a>.</p>
				<div class="spacer"></div>
			</div>
